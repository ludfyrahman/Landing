...
<body>
    ...
    <section class="space" data-bg-src="fe_assets/img/bg/testi_bg_1.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7">
                    <div class="testi-card-tab" data-asnavfor=".testi-card-slide"><button class="tab-btn active"
                            type="button"><img src="fe_assets/img/testimonial/testi_1_1.jpg" alt="tab-btn image"></button>
                        <button class="tab-btn" type="button"><img src="fe_assets/img/testimonial/testi_1_2.jpg"
                                alt="tab-btn image"></button> <button class="tab-btn" type="button"><img
                                src="fe_assets/img/testimonial/testi_1_3.jpg" alt="tab-btn image"></button> <button
                            class="tab-btn" type="button"><img src="fe_assets/img/testimonial/testi_1_4.jpg"
                                alt="tab-btn image"></button> <button class="tab-btn" type="button"><img
                                src="fe_assets/img/testimonial/testi_1_5.jpg" alt="tab-btn image"></button> <button
                            class="tab-btn" type="button"><img src="fe_assets/img/testimonial/testi_1_6.jpg"
                                alt="tab-btn image"></button></div>
    ...
    <section class="space">
        <div class="container">
            ...
            <div class="blog-grid-wrap">
                <div class="blog-grid">
                    <div class="blog-img"><img src="fe_assets/img/blog/blog_1_1.jpg" alt="blog image"></div>
                ...
                <div class="blog-grid">
                    <div class="blog-img"><img src="fe_assets/img/blog/blog_1_2.jpg" alt="blog image"></div>
                ...
                <div class="blog-grid">
                    <div class="blog-img"><img src="fe_assets/img/blog/blog_1_3.jpg" alt="blog image"></div>
                    <div class="blog-content"><a class="tag" href="blog.html">Learning</a>
        ...
        <div class="shape-mockup jump-reverse d-none d-lg-block" data-bottom="28%" data-right="3%"><img
                src="fe_assets/img/shape/circle_3.png" alt="shapes"></div>
        <div class="shape-mockup jump d-none d-lg-block" data-top="44%" data-left="0%"><img
                src="fe_assets/img/shape/circle_4.png" alt="shapes"></div>
    </section>
        ...
        <div class="container">
            <div class="cta-wrap">
                <div class="row flex-row-reverse justify-content-between">
                    <div class="col-lg-6">
                        <div class="cta-img"><img src="fe_assets/img/normal/cta_1_1.png" alt="Image"></div>
                    </div>
                ...
                <div class="shape-mockup movingX z-index-n1" data-bottom="0%" data-left="44%"><img
                        src="fe_assets/img/shape/dot_shape_1.png" alt="shapes"></div>
            </div>
        </div>
    </section>
